    ...
    */
    ...
    'connectors' => [
        'appstore' => [
            ...
            'throttle' => [
                'sync_jobs' => env('APPSTORE_THROTTLE_SYNC_JOBS', 3),
        ...
        'gplay' => [
            ...
            'throttle' => [
                'sync_jobs' => env('GPLAY_THROTTLE_SYNC_JOBS', 2),
    ...
    */
    ...
    'sync' => [
        'ios' => [
            ...
            'discovery_app_refresh_hours' => env('SYNC_IOS_DISCOVERY_REFRESH_HOURS', 72),
        ...
        'android' => [
            ...
            'discovery_app_refresh_hours' => env('SYNC_ANDROID_DISCOVERY_REFRESH_HOURS', 72),
